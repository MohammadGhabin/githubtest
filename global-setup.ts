...
async function globalSetup(config: FullConfig) {
  ...
  await util.click(signInPageSelectors.signInLink, signInPageSelectors.signInForm, state.attached);
  ...
  await util.click(signInPageSelectors.signInButton, homePageSelectors.navigationMenu, state.attached);
